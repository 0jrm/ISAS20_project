...
def train_autoencoder(model, train_loader, val_loader, num_epochs, device, model_name):
    ...
    for epoch in range(num_epochs):
        ...
        if val_loss < best_val_loss:
            ...
            os.makedirs('saved_models_global', exist_ok=True)
            torch.save(model.state_dict(), f'saved_models_global/best_{model_name}.pth')
...
def main():
    ...
    # Load data
    data_path = '/unity/g2/jmiranda/SubsurfaceFields/Data/ISAS20_ARGO/ISAS20_project/utils/NeSPReSO_v1_global_sat/preprocessed_satellite_data.pkl'
    ...
    for parameter_name in parameter_names:
        ...
        for layout, layout_name in zip(layer_layouts, layout_names):
            ...
            for dim in encoding_dims:
                ...
                model_path = os.path.join('saved_models_global', f'best_{model_name_full}.pth')
            ...
            plot_residuals_grid(test_data, all_reconstructions_test, all_pca_reconstructions_test, test_mask, encoding_dims, depth_list, parameter_name)

            # Best/Worst plots per encoding dimension
            for idx_dim, dim in enumerate(encoding_dims):
                plot_best_worst_profiles(test_data, test_mask,
